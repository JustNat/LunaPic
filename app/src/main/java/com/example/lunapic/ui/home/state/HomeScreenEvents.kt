...
sealed interface HomeScreenEvents {
    ...
    data class SetSelectedBucket(val selectedBucket: Int) : HomeScreenEvents
    data class DeleteBucket(val bucket: Bucket) : HomeScreenEvents
    ...
    data object RegisterBucketsPrivacy : HomeScreenEvents
    data class SetBucketPrivacy(val index: Int) : HomeScreenEvents
}